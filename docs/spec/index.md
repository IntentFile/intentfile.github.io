...
Version 1.8 · vendor-neutral · normative source: [IntentFile/intent-specification](https://github.com/IntentFile/intent-specification) ([versions/1.8.md](https://github.com/IntentFile/intent-specification/blob/main/versions/1.8.md))
